...
public class Alarm implements Comparable<Alarm>
{
  ...
  {
    intent.putExtra("com.example.medibud.id", mId);
    intent.putExtra("com.example.medibud.title", mTitle);
    intent.putExtra("com.example.medibud.date", mDate);
    intent.putExtra("com.example.medibud.alarm", mEnabled);
    intent.putExtra("com.example.medibud.occurence", mOccurence);
    intent.putExtra("com.example.medibud.days", mDays);
  }

  public void fromIntent(Intent intent)
  {
    mId = intent.getLongExtra("com.example.medibud.id", 0);
    mTitle = intent.getStringExtra("com.example.medibud.title");
    mDate = intent.getLongExtra("com.example.medibud.date", 0);
    mEnabled = intent.getBooleanExtra("com.example.medibud.alarm", true);
    mOccurence = intent.getIntExtra("com.example.medibud.occurence", 0);
    mDays = intent.getIntExtra("com.example.medibud.days", 0);
    update();
  }
